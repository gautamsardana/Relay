...
Tests target the parts where being wrong is silent: seniority ranking, years-of-experience
parsing (including false positives like "16-17 year olds" in unrelated boilerplate), location
matching, category exclusions, and rate-limit classification.
...
I want to do something with agentic transactions. The reason I have made this fancy infrastructure is so that I
